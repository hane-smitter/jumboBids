...
export const fetchBiddableProducts = (query) => request.get(`/products/bids${query}`);
...
export const fetchTopBidder = (body) => request.get(`/bids/amount/high?productId=${body.productId}`);
export const fetchLastBidder = (body) => request.get(`/bids/last?productId=${body.productId}`);
export const fetchCurrentBidder = (body) => request.get(`/bids/current-bidders?productId=${body.productId}`);
